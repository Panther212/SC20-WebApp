...
with col2:
 fig = go.Figure()
 fig.add_trace(go.Scatter(x=['Jan', 'Feb', 'March', 'April', 'May','June'], y=[20, 40, 25, 10,50,35], fill='tozeroy',mode='none',name='Plot 1',line_shape='spline')) # fill down to xaxis
 fig.add_trace(go.Scatter(x=['Jan', 'Feb', 'March', 'April', 'May','June'], y=[15, 10, 40, 40,25,60], fill='tonexty',mode='none',name='Plot 2',line_shape='spline')) # fill to trace0 y
 fig.update_layout(
    title="6 Months Data",
    xaxis_title="Month",
