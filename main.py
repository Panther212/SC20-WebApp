...
timestamp = db.collection("DevMode").doc('T1R1S1').to_dict()['timestamp'];
...
with col1:
 ...
 if option == "1 Week Data":
    ...
    fig.add_trace(go.Scatter(x=['Mon', 'Tue', 'Wed', 'Thu', 'Fri','Sat'], y=[0, 0, 0, Inf_per,0,0], fill='tozeroy',mode='none',name='Plot 3',line_shape='spline'))# fill to trace0 y
    fig.update_layout(
       title="1 Week Data",
       xaxis_title="Day",
